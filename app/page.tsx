      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div ref={portfolioToggleRef} className="bg-white rounded-2xl border border-gray-200 p-12 flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-bold">포트폴리오 중심 교육</h3>
              <p className="text-muted-foreground mt-2 max-w-md">학생들은 PCPA와 함께 세상의 없는 나만의 프로젝트를<br />만들며 가시적인 결과물을 만들어냅니다.</p>
            </div>
            <div className={`w-32 h-16 rounded-full relative p-2 transition-colors duration-700 ${isPortfolioActive ? 'bg-yellow-300' : 'bg-gray-300'}`}>
              <div className={`w-12 h-12 bg-white rounded-full absolute flex items-center justify-center transition-all duration-700 ${isPortfolioActive ? 'right-2' : 'left-2'}`}>
          ...
          <div ref={vibeToggleRef} className="bg-white rounded-2xl border border-gray-200 p-12 flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-bold">바이브 코딩 교육</h3>
              <p className="text-muted-foreground mt-2 max-w-md">학생들로 하여금 창의성과 문제해결에 집중하게 하며,<br />AI는 프로젝트의 구현을 위한 파트너 역할을 맡습니다.</p>
            </div>
            <div className={`w-32 h-16 rounded-full relative p-2 transition-colors duration-700 ${isVibeActive ? 'bg-blue-800' : 'bg-gray-300'}`}>
              <div className={`w-12 h-12 bg-white rounded-full absolute flex items-center justify-center transition-all duration-700 ${isVibeActive ? 'right-2' : 'left-2'}`}>
