    						      ...
    						      <div className="container mx-auto px-4 md:px-6">
    						        ...
    						        <div className="max-w-4xl mx-auto space-y-8">
    						          <div ref={portfolioToggleRef} className="bg-white rounded-2xl border border-gray-200 p-12 flex items-center justify-between">
    						            <div>
    						              <h3 className={`text-3xl font-bold transition-colors duration-700 ${isPortfolioActive ? 'text-gray-800' : 'text-gray-500'}`}>포트폴리오 중심 교육</h3>
    						          ...
    						          <div ref={vibeToggleRef} className="bg-white rounded-2xl border border-gray-200 p-12 flex items-center justify-between">
    						            <div>
    						              <h3 className={`text-3xl font-bold transition-colors duration-700 ${isVibeActive ? 'text-gray-800' : 'text-gray-500'}`}>바이브 코딩 교육</h3>
